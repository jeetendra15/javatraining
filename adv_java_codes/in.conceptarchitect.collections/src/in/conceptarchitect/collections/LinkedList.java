...
public class LinkedList<X> {
	...
	/*
	 * Should Create a String representing all value from the list Example1: List
	 * contains "india","usa","france" Output: LinkedList(\tIndia,\tusa\tfrance\t)
	 * Example2: List is empty Output: LinkedList()
	 */
	@Override
