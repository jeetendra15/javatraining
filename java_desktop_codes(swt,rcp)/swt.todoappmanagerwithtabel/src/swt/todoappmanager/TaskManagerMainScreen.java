...
//	String imageBasePath = "/images/";
	...
	public void build(Composite parent) {
		...
		new TaskListScreen(projectManager.getTasks()).build(tableContainer);
	...
	private ToolBar buildToolbar(Shell shell) {
		...
		newTask.setImage(image("./../images/add-icon.jpg"));

		ToolItem removeTask = new ToolItem(toolBar, SWT.PUSH);
		removeTask.setImage(image("./../images/delete2.jpg"));
	...
	private Image image(String name) {
		...
		Image image = new Image(display, name);
